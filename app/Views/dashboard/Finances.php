                        ...
                        <div class="card-body">
                            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="col-sm-12 col-md-6">
                                        <a href="/finances/add" type="button" class="btn btn-info  btn-flat"><i class="fas fa-plus"></i> Tambah Data</a>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Jumlah</th>
                                            ...
                                            <?php foreach ($objek as $r) : ?>
                                                <tr class="odd">
                                                    ...
                                                    <td><?= $r['description']; ?></td>
                                                    <td><?= $r['date']; ?></td>
                                                    <?php if ($r["note"] == "income") :  ?>
                                                        <td class="text-success">Rp <?= number_format($r['amount'], 0, ',', '.'); ?></td>
                                                    <?php else :  ?>
                                                        <td class="text-danger">Rp - <?= number_format($r['amount'], 0, ',', '.'); ?></td>
                                                    <?php endif  ?>                                            
                                                    <td><?= $r['note']; ?></td>
                                                    <td>
                                                    <a href="/finances/edit/<?= $r['id']; ?>" type="submit" class="btn btn-warning">Edit</a>
                                                    <a href="/finances/delete/<?= $r['id']; ?>" type="submit" class="btn btn-danger">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
